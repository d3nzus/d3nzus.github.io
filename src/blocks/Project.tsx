...
function Project() {
  ...
  return (
    <div className="container mx-auto top-10 relative align-middle justify-center">
      <h1 className="text-6xl font-bold text-white my-10 text-center">I'VE WORKED ON:</h1>

      <ProjectCard project={projects[projectIndex]} />

      <div className="flex align-middle justify-center gap-4 ">
        <button
          className="bg-gray-700 text-white text-2xl px-4 py-2 rounded-lg mt-4 h-fit"
          id="projectPrev"
          onClick={prevProject}
        >
          Previous
